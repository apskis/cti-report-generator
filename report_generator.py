...
def generate_report(analysis_result):
    ...
    try:
        ...
        if cve_analysis:
            ...
            cve_table.style = 'Light Grid Accent 1'
            ...
            for cve in cve_analysis:
                ...
                # High = Orange text
                    ...
                    row_cells[1].paragraphs[0].runs[0].font.color.rgb = RGBColor(255, 165, 0)
        ...
        if apt_activity:
            for apt in apt_activity:
                ...
                para = doc.add_paragraph(apt_text, style='List Bullet')
        else:
...
def upload_to_blob(document, storage_account_name, storage_account_key, container_name="reports"):
    """
    ...
    Args:
        ...
        container_name: Blob container name (default: "reports")
    ...
    try:
        ...
        # Generate SAS URL with 7-day read permissions
        ...
        sas_url = f"https://{storage_account_name}.blob.core.windows.net/{container_name}/{filename}?{sas_token}"
        logger.info(f"Generated SAS URL (valid for 7 days)")
...
def create_and_upload_report(analysis_result, storage_account_name, storage_account_key):
    """
