...
class AgentContextManager:
    ...
    def save_analysis_context(self, report_type: str, report_date: datetime, analysis_result: dict[str, Any]) -> bool:
        """
    ...
    def _save_cve_tracking(self, report_type: str, date_str: str, analysis_result: dict[str, Any]):
    ...
    def _save_actor_timeline(self, report_type: str, date_str: str, analysis_result: dict[str, Any]):
    ...
    def get_previous_context(
        self, report_type: str, current_date: datetime | None = None, lookback_weeks: int = 4
    ) -> list[dict[str, Any]]:
        """
    ...
    def calculate_cve_trends(
        self, current_cves: list[dict[str, Any]], previous_contexts: list[dict[str, Any]]
    ) -> dict[str, Any]:
        """
        ...
        for context in previous_contexts:
            ...
            historical_cve_ids.update(cve.get("cve_id") for cve in cve_analysis if cve.get("cve_id"))
    ...
    def calculate_actor_trends(
        self, current_actors: list[dict[str, Any]], previous_contexts: list[dict[str, Any]]
    ) -> dict[str, Any]:
        """
        ...
        for context in previous_contexts:
            ...
            historical_actor_names.update(a.get("actor") for a in apt_activity if a.get("actor"))
    ...
    def get_historical_statistics(self, report_type: str, lookback_weeks: int = 12) -> dict[str, Any]:
        """
        ...
        return {"available": True, "timeline": timeline, "weeks_analyzed": len(timeline)}

    def list_available_contexts(self, report_type: str | None = None) -> list[str]:
        """
